...
class PlanningViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, ExportToForeFlightDelegate, UITextFieldDelegate {
    ...
    func updateMainDisplay() {
        ...
        rcMachValueLabel.text = charted.rcMach.toStringWithNumberOfDecimal(0)
        ...
        mrcMachValueLabel.text = charted.mrcMach.toStringWithNumberOfDecimal(0)
        ...
        p9MMachValueLabel.text = charted.p9mMach.toStringWithNumberOfDecimal(0)
